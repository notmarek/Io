...
export let get_info = async () =>
  window.session.get("info") ||
  window.session.set("info", await http.get("/na/info").json());
...
export const library = {
  ...
  scan: async (id) =>
    await http
      ...
      .json(),
  create: async (name, path, depth) =>
    await http.put(`/api/library`, {
